...
if menu == 'Introducción':
    ...
    img =Image.open("Codigo/Imagenes/minecraft.jpg")
    ...
    img =Image.open("Codigo/Imagenes/apex.png")
    st.image(img,use_column_width="always")
    ...
    img =Image.open("Codigo/Imagenes/amongus.jpg")
    st.image(img,use_column_width="always")
    ...
    img =Image.open("Codigo/Imagenes/wow.jpg")
    st.image(img,use_column_width="always")  
    ...
    img =Image.open("Codigo/Imagenes/lol.jpg")
    st.image(img,use_column_width="always")
else:
